...
public class Hzipping {
	...
	public static void fakezip(String fname) {
		...
		filei.setReadable(true);
		filei.setWritable(true);

		fileo = new File("fakezipped.txt");
		fileo.setExecutable(true);
		fileo.setReadable(true);
		fileo.setWritable(true);
		try {
	...
	public static void realzip(String fname, String fname1) {
		...
		filei.setReadable(true);
		filei.setWritable(true);
		System.out.println(filei.canExecute() + " " + filei.canRead() + " " + filei.canWrite());
